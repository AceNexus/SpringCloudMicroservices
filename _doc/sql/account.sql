-- 20240803 新增 ecommerce_account 資料表
...
-- 20240803 新增 user_auth_providers 資料表
CREATE TABLE user_auth_providers (
    auth_id CHAR(36) NOT NULL DEFAULT (UUID()),
    user_id CHAR(36) NOT NULL,
...
-- 20240803 新增 password_reset 資料表
-- 使用流程: a.用戶請求重置密碼
